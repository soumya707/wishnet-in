...
Revision ID: d69147c0a89f
Revises: e3e8e1791007
Create Date: 2019-12-12 23:14:16.688695
...
revision = 'd69147c0a89f'
down_revision = 'e3e8e1791007'
branch_labels = None
depends_on = None
...
def upgrade_connection():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('new_connection', 'remark')
    # ### end Alembic commands ###


def downgrade_connection():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('new_connection', sa.Column('remark', mysql.TEXT(), nullable=True))
    # ### end Alembic commands ###
