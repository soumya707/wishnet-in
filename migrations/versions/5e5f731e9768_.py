...
Revision ID: 5e5f731e9768
Revises: 2fb4332921a1
Create Date: 2019-11-12 22:30:57.421170
...
revision = '5e5f731e9768'
down_revision = '2fb4332921a1'
branch_labels = None
depends_on = None
...
def upgrade_users():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('zone_id_with_plan_code', sa.Column('status', sa.String(length=10), nullable=False))
    # ### end Alembic commands ###


def downgrade_users():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('zone_id_with_plan_code', 'status')
