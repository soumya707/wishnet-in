...
Revision ID: 930ce961b40d
Revises: 4cbb68bb2f3f
Create Date: 2020-01-23 22:05:57.142080
...
revision = '930ce961b40d'
down_revision = '4cbb68bb2f3f'
branch_labels = None
depends_on = None
...
def upgrade_lco():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('lco_info', 'status',
               existing_type=mysql.INTEGER(display_width=2),
               nullable=False)
    op.drop_column('lco_login', 'status')
    # ### end Alembic commands ###


def downgrade_lco():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('lco_login', sa.Column('status', mysql.VARCHAR(length=8), nullable=True))
    op.alter_column('lco_info', 'status',
               existing_type=mysql.INTEGER(display_width=2),
               nullable=True)
    # ### end Alembic commands ###
