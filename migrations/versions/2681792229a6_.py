...
Revision ID: 2681792229a6
Revises: 5e3f4d0af875
Create Date: 2019-09-14 23:16:52.659118
...
revision = '2681792229a6'
down_revision = '5e3f4d0af875'
branch_labels = None
depends_on = None
...
def upgrade_ticket():
    ...
    sa.Column('category_desc', sa.String(length=50), nullable=False),
    sa.Column('nature_desc', sa.String(length=50), nullable=False),
