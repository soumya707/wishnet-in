...
Revision ID: d0b0d3c37fc2
Revises: 28ada274161a
Create Date: 2019-09-14 19:30:21.196915
...
revision = 'd0b0d3c37fc2'
down_revision = '28ada274161a'
branch_labels = None
depends_on = None
...
def upgrade_recharge():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('tariff_info',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('plan_name', sa.String(length=50), nullable=False),
    sa.Column('mqs_name', sa.String(length=50), nullable=False),
