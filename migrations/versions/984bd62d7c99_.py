...
Revision ID: 984bd62d7c99
Revises: d02514c5640c
Create Date: 2020-01-28 11:41:45.362959
...
revision = '984bd62d7c99'
down_revision = 'd02514c5640c'
branch_labels = None
depends_on = None
...
def upgrade_assets():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('biz_plan', sa.Column('ott', sa.Integer(), nullable=True))
    op.add_column('ftth_plan', sa.Column('ott', sa.Integer(), nullable=True))
    op.add_column('unlimited_plan', sa.Column('ott', sa.Integer(), nullable=True))
    # ### end Alembic commands ###


def downgrade_assets():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('unlimited_plan', 'ott')
    op.drop_column('ftth_plan', 'ott')
    op.drop_column('biz_plan', 'ott')
    # ### end Alembic commands ###
