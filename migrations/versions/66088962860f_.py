...
Revision ID: 66088962860f
Revises: ee256316b811
Create Date: 2020-01-20 06:47:52.139082
...
revision = '66088962860f'
down_revision = 'ee256316b811'
branch_labels = None
depends_on = None
...
def upgrade_voucher():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('tbl_ott_voucher_log', sa.Column('voucher_end_dt', sa.Date(), nullable=True))
    # ### end Alembic commands ###


def downgrade_voucher():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('tbl_ott_voucher_log', 'voucher_end_dt')
