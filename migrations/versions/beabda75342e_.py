...
Revision ID: beabda75342e
Revises: 8b211aacb580
Create Date: 2020-01-09 23:36:47.580065
...
revision = 'beabda75342e'
down_revision = '8b211aacb580'
branch_labels = None
depends_on = None
...
def upgrade_recharge():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('recharge_entry', sa.Column('plan_code', sa.String(length=50), nullable=True))
    # ### end Alembic commands ###


def downgrade_recharge():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('recharge_entry', 'plan_code')
    # ### end Alembic commands ###
