...
Revision ID: 46e4ffc20fc1
Revises: d69147c0a89f
Create Date: 2019-12-16 16:19:37.370579
...
revision = '46e4ffc20fc1'
down_revision = 'd69147c0a89f'
branch_labels = None
depends_on = None
...
def upgrade_assets():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('biz_plan', sa.Column('softphones', sa.Integer(), nullable=True))
    op.add_column('ftth_plan', sa.Column('softphones', sa.Integer(), nullable=True))
    op.add_column('unlimited_plan', sa.Column('softphones', sa.Integer(), nullable=True))
    # ### end Alembic commands ###


def downgrade_assets():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('unlimited_plan', 'softphones')
    op.drop_column('ftth_plan', 'softphones')
    op.drop_column('biz_plan', 'softphones')
    # ### end Alembic commands ###
