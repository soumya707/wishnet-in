...
Revision ID: 07d770cf0052
Revises: 1c0001b365a5
Create Date: 2020-01-25 12:26:55.681981
...
revision = '07d770cf0052'
down_revision = '1c0001b365a5'
branch_labels = None
depends_on = None
...
def upgrade_voucher():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('tbl_ott_pkg')
    op.add_column('tbl_ott_provider', sa.Column('ott_provider_app_name', sa.String(length=50), nullable=True))
    op.alter_column('tbl_ott_provider', 'ott_provider_code',
               existing_type=mysql.VARCHAR(length=8),
               nullable=False)
    op.alter_column('tbl_ott_provider', 'ott_provider_name',
               existing_type=mysql.VARCHAR(length=100),
               nullable=False)
    op.alter_column('tbl_ott_provider', 'ott_provider_status',
               existing_type=mysql.VARCHAR(length=15),
               nullable=False)
    op.alter_column('tbl_voucher', 'ott_pkg_code',
               existing_type=mysql.VARCHAR(length=8),
               nullable=False)
    op.alter_column('tbl_voucher', 'ott_provider_code',
               existing_type=mysql.VARCHAR(length=8),
               nullable=False)
    op.alter_column('tbl_voucher', 'ott_voucher_code',
               existing_type=mysql.VARCHAR(length=50),
               nullable=False)
    op.alter_column('tbl_voucher', 'ott_voucher_end_dt',
               existing_type=sa.DATE(),
               nullable=False)
    op.alter_column('tbl_voucher', 'ott_voucher_start_dt',
               existing_type=sa.DATE(),
               nullable=False)
    op.alter_column('tbl_voucher', 'ott_voucher_status',
               existing_type=mysql.VARCHAR(length=15),
               nullable=False)
    # ### end Alembic commands ###
...
def downgrade_voucher():
    ...
    op.alter_column('tbl_ott_provider', 'ott_provider_code',
               existing_type=mysql.VARCHAR(length=8),
               nullable=True)
    op.drop_column('tbl_ott_provider', 'ott_provider_app_name')
