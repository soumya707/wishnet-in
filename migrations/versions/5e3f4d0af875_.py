...
Revision ID: 5e3f4d0af875
Revises: d0b0d3c37fc2
Create Date: 2019-09-14 22:50:44.494470
...
revision = '5e3f4d0af875'
down_revision = 'd0b0d3c37fc2'
branch_labels = None
depends_on = None
...
def upgrade_ticket():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('ticket_info',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('ticket_category_code', sa.String(length=20), nullable=False),
    sa.Column('ticket_category_desc', sa.String(length=50), nullable=False),
    sa.Column('ticket_nature_code', sa.String(length=20), nullable=False),
    sa.Column('ticket_nature_desc', sa.String(length=50), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('ticket_nature_code'),
    sa.UniqueConstraint('ticket_nature_desc')
    )
    # ### end Alembic commands ###
