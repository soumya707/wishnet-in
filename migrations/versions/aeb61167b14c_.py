...
Revision ID: aeb61167b14c
Revises: 5832e2f39a43
Create Date: 2019-11-20 23:47:48.650505
...
revision = 'aeb61167b14c'
down_revision = '5832e2f39a43'
branch_labels = None
depends_on = None
...
def upgrade_recharge():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('recharge_entry', 'ref_id')
    # ### end Alembic commands ###


def downgrade_recharge():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('recharge_entry', sa.Column('ref_id', mysql.VARCHAR(length=20), nullable=True))
    # ### end Alembic commands ###
