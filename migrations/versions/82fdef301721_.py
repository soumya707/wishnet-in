...
Revision ID: 82fdef301721
Revises: beabda75342e
Create Date: 2020-01-15 12:09:44.436111
...
revision = '82fdef301721'
down_revision = 'beabda75342e'
branch_labels = None
depends_on = None
...
def upgrade_users():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('email_address_update_request',
...
def downgrade_users():
    ...
    op.alter_column('customer_info', 'billing_address',
               existing_type=mysql.VARCHAR(length=500),
               nullable=True)
    op.drop_table('email_address_update_request')
    op.drop_table('aadhar_update_request')
    # ### end Alembic commands ###
